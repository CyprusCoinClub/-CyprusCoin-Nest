...
const urlCyprusCoinRemoteNodes = "https://raw.githubusercontent.com/calexcore/cypruscoin-nodes-json/master/cypruscoin-nodes.json"
...
func requestListRemoteNodes() (remoteNodes []node) {
	...
	theNodes := new(nodes)
	err := getJSONFromHTTPRequest(urlCyprusCoinRemoteNodes, theNodes)
